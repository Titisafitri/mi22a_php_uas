...
if (isset($_POST['simpan'])) {
    ...
    if ($nama && $kategori && $deskripsi && $gambar) {
        if ($op == 'edit') { //untuk update
            $sql       = "update produk set kode_produk = '$id', nama_produk='$nama', kategori_produk = '$kategori', deskripsi_produk='$deskripsi', gambar='$gambar' where kode_produk = '$id'";
            $q1         = mysqli_query($koneksi, $sql);
            if ($q1) {
            ...
            $sql   = "insert into produk(nama_produk, kategori_produk, deskripsi_produk, gambar) values ('$nama','$kategori','$deskripsi','$gambar')";
            $q1     = mysqli_query($koneksi, $sql);
            if ($q1) {
